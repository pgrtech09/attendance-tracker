...
import { subjectWiseStats, averageSubjectPercentage, remainingWorkingDaysInRange, tallyRecords, targetProjection, todayLocalISO } from './attendance-calc.js';
...
async function loadDashboard(userId) {
  ...
  try { renderStatCards(subjects || [], attendance || [], settings, holidays || [], timetableAll || []); } catch (e) { console.error('renderStatCards failed', e); }
...
function renderStatCards(subjects, attendance, settings, holidays, timetableAll) {
