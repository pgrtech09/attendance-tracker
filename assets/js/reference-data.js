...
export const STATUS_META = {
  ...
  non_working:   { label: 'Non-Working',   color: 'var(--nonworking)', affectsAttendance: false, countsTowardTotal: false },
  medical_leave: { label: 'Medical Leave', color: 'var(--medical)',    affectsAttendance: false, countsTowardTotal: false },
  od:            { label: 'On Duty (OD)',  color: 'var(--od)',         affectsAttendance: false, countsTowardTotal: false }
};
