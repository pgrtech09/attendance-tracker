...
import { subjectWiseStats, averageSubjectPercentage, computeHourStats, distinctDateCount } from './attendance-calc.js';
...
const [{ data: subjects }, { data: attendance, fromCache }, { data: timetable }] = await Promise.all([
