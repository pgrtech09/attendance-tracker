...
import { subjectWiseStats, averageSubjectPercentage, computeHourStats, distinctDateCount, todayLocalISO } from './attendance-calc.js';
...
const stats = subjectWiseStats(attendance || [], subjects || [], timetable || []);
